...
export default function Login() {
  ...
  return (
    <>
      <section className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-green-600 to-black">
        <div className="flex max-w-3xl items-center rounded-3xl bg-gray-100 p-5 shadow-lg">
          <div className="mb-12 px-8 md:w-1/2 md:px-16">
            ...
            <button
              ...
              className="mt-5 flex w-full items-center justify-center rounded-xl border bg-white py-2 text-sm text-green-600 duration-300 hover:scale-105"
            >
              <img
                src="imgs/google.png"
                alt="Logo do Google"
